...
async function onchainTestScript() {
    ...
    console.log(`Please, scan your QR-code below to deploy the contract:`);
    ...
    setInterval(async () => {
        ...
        if (exitCode !==0) {
            console.log("Running getting method failed");
            return;
        }
        ...
        if (
            ...
            console.log(
                ...
                most_recent_sender.toString({ bounceable: false, testOnly: true })
            );
